...
class BackboneResNet(nn.Module):
    ...
    def __init__(self, name='resnet50', head='mlp', feat_dim=128, seed=777, cfg=None):
        ...
        if head == 'linear':
            ...
            # 最初のfc層は cfg.cls_per_task の出力のみ
            # self.head = nn.Linear(dim_in, cfg.cls_per_task)
            self.head = SimpleLinear(dim_in, cfg.continual.cls_per_task[0])
